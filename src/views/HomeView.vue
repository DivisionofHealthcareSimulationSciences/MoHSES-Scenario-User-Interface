      ...
      <v-window v-model="tab">
        ...
        <v-window-item value="option-5" :transition="false" :reverse-transition="false">
          <div v-for="(exp, index) in capability" :key="index">
              ...
              <v-text-field v-model="exp.name" label="Capability Name" clearable > </v-text-field>
              <v-text-field v-model="exp.data" label="Configuration Data" clearable></v-text-field>
              <v-text-field v-model="exp.propertyName" label="Property Name" clearable></v-text-field>
              <v-select v-model="exp.dataType" label="Data Type" :items="['string', 'number', 'boolean', 'option']" clearable ></v-select>
              <v-file-input v-model="exp.value" label="Value" clearable></v-file-input>
