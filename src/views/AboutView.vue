<template>
  ...
  >
    ...
    <path
      @click="pathClicked('shoulder-left')"
      id="shoulder-left"
    ...
    <path
      @click="pathClicked('shoulder-right')"
      id="shoulder-right"
    ...
    <path
      @click="pathClicked('forearm-left')"
      id="forearm-left"
    ...
    <path
      @click="pathClicked('forearm-right')"
      id="forearm-right"
    ...
    <path
      @click="pathClicked('innerthigh-left')"
      id="innerthigh-left"
    ...
    <path
      @click="pathClicked('innerthigh-right')"
      id="innerthigh-right"
    ...
    <path
      ...
      id="hands-left" />
    <path
      @click="pathClicked('armback-left')"
      id="armback-left"
    ...
    <path
      ...
      id="nape" />
    <path
      @click="pathClicked('armback-right')"
      id="armback-right"
    ...
    <path
      ...
      id="back-left" />
    <path
      @click="pathClicked('clavicule-left')"
