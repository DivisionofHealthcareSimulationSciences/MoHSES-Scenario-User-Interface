    ...
    <v-col cols="3">
      ...
      <v-window v-model="tab">
        ...
        <v-window-item value="option-3" :transition="false" :reverse-transition="false">
          <v-card flat>
            <v-card-text>
              put updated manikin figure here
              </v-card-text>
              <v-btn
              :disabled="!valid"
              color="success"
