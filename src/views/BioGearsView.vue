              ...
              <v-card color="white" flat>
							...
							<v-container fluid>
								<v-row align="center" justify="center">
									<v-col cols="12">
										<v-img src="@/assets/crest_vh_gold_purple_dt.png" alt="Your image" class="mx-auto" width="70%" height="70%" /> </v-col>
								</v-row>
							</v-container>
							<v-card-text>
...
export default {
	...
	methods: {
        ...
        console.log(id);
				...
				if(this.action.some(x => Object.keys(x).includes(id))) { // this.action.some(x => Object.keys(x).includes(id))
        ...
        // pathElement.classList.contains("active")
